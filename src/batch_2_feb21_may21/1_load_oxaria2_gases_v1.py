...
# File locations
#----------------
the_folder = './oxaria/data/raw/2oxaria/json/gap_filling/batch_2_feb21_may21/'
...
#---------------------------------------------------------------
oxaria2_gases = oxaria2_gases[~oxaria2_gases.index.duplicated(keep='last')]
oxaria2_gases.reset_index(inplace=True)
oxaria2_gases = oxaria2_gases.dropna(axis=0,subset=['tag','rec']).set_index(['tag','rec'])
...
# -----------------------
oxaria2_gases = oxaria2_gases.merge(
...
# Saving to an ftr 
#------------------
oxaria2_gases.reset_index().to_feather(the_folder+'oxaria2_gases_q12021_gf.ftr')
