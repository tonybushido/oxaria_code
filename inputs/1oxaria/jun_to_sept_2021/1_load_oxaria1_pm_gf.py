...
oxaria1_pm = load4gascsv_v2(folder=the_folder, topic='particulate').sort_index()
...
oxaria1_pm = oxaria1_pm.merge(df_device_names, how='left', left_index=True, right_index=True)

# Saving to an ftr
#------------------
print('Writing to ftr...')
oxaria1_pm.reset_index().to_feather(the_folder+'oxaria1_pm_gf_oct.ftr')
print('\nAll done for pm.')
