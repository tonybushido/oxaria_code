...
# File locations
#----------------
the_folder = '/home/tonyb/Gdrive/MinicondaProjects/oxaria/data/raw/1oxaria/json/gap_filling/jun_to_sept_2021/'
#/Gdrive/MinicondaProjects/oxaria/data/raw/1oxaria/json/gap_filling/jun_to_sept_2021

# Loading climate data with load4gascsv function
#------------------------------------------------
...
#-----------------------------------------------------
devices = oxaria1_climate.index.get_level_values(0).unique()
...
oxaria1_climate = oxaria1_climate.merge(df_device_names, how='left', left_index=True, right_index=True)

# Saving to an ftr
#------------------
print('Writing to ftr...')
oxaria1_climate.reset_index().to_feather(the_folder+'oxaria1_climate_gf_oct.ftr')
